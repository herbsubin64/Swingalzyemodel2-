  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-6">
      ...
      <p className="mt-2 text-sm text-gray-600">
        Load a <strong>user</strong> video and a <strong>reference</strong> video. Toggle overlay; adjust opacity and swing-plane guides.
      </p>
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3 rounded-md border p-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <input type="range" min={10} max={70} step={1} value={swingAngle}
            onChange={(e)=>setSwingAngle(parseInt(e.target.value))}/>
